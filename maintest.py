...
flags.DEFINE_integer("input_height", 128, "The size of image to use [64,128]")
flags.DEFINE_integer("input_width", 128, "The size of image to use [64, 128]")
...
flags.DEFINE_string("dataset", "CUF101Surfingaffinenew", "The name of dataset [MNIST, UCF101, d2shape]")
